...
import { Rating, Loader, Message, LoaderButton, Meta } from '../components';
            ...
            {isLoading ? (
                ...
                <Message variant="danger">
                    ...
                    <Row>
                        ...
                        <Col md={5}>
                            <img src={product.image} alt={product.name} fluid className='productImage' />
                        </Col>
                        <Col md={4}>
                                ...
                                <ListGroup.Item>
                                    ...
                                    {userInfo ? (
                                        <Form onSubmit={submitHandler}>
                                            ...
                                            >
                                                {loadingProductReview ? <LoaderButton /> : "Submit"}
                                            </Button>
                                        </Form>
                                    ) : (
                                        <Message>
